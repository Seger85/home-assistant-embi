...
Registry operations require exact EMBi ownership by domain, platform, config entry, and unique ID. Unrelated entities and a foreign entity occupying a desired sensor or player entity ID are left untouched. Direct `.storage` changes are unsupported.
